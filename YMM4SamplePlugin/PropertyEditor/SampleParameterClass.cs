...
using YMM4SamplePlugin.PropertyEditor.CustomPropertyEditor;
...
namespace YMM4SamplePlugin.PropertyEditor
{
    ...
    public class SampleParameterClass : Animatable
    {
        ...
        protected override IEnumerable<IAnimatable> GetAnimatables() => [Animation, Inner];
    }
    public class InnerClass : Animatable
    {
        ...
        protected override IEnumerable<IAnimatable> GetAnimatables() => [Child1, Child2];
    }
}